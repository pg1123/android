<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:29:"themes/fanbao/portal/ios.html";i:1526182160;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
    ...
    <div class=mouse_direction>
       ...
       <div class="main">
          ...
          <ul>
             ...
             <li><a href="<?php echo cmf_url('portal/Article/ios',array('id'=>$art['id'],'cid'=>$art['category_id'], 'sid' => $key+1)); ?>">
