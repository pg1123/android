<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:37:"themes/fanbao/portal/article_ios.html";i:1526183333;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
   ...
   <body class="fbz">
    <div id="fbz">
       <!--头部开始-->
       <div class="header">
       <a href="<?php echo cmf_url('portal/Index/ios'); ?>"><i class="fa fa-angle-left" aria-hidden="true"></i></a>
       <p>平台详情</p>
       </div>
       <!--头部结束-->
       <!--主体部分开始-->
