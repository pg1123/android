<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:33:"themes/fanbao/portal/android.html";i:1526183129;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
   ...
   <body>
    ...
    <div class=mouse_direction>
        ...
        <div class=mouse_bottom></div>
          ...
          <button id="gonglue" data-url="/portal/Index/gonglue"><a href="">试玩攻略</a></button>
       </div>
       <div class="main">
          <div class="clearfix"><h2>赚钱优先</h2><span>726人正在试玩中</span></div>
          <ul>
             ...
             <li><a href="<?php echo cmf_url('portal/Article/android',array('id'=>$art['id'],'cid'=>$art['category_id'], 'sid' => $key+1)); ?>">
